...
export const opportunities: Opportunity[] = [
  {
    ...
    companyDescription: "Крупнейшая нефтегазовая компания с фокусом на цифровую трансформацию. Активно инвестирует в технологические решения для оптимизации добычи и переработки.",
    employeeCount: 78000,
  ...
  },
  {
    ...
    companyDescription: "Технологическое подразделение крупнейшего банка. Разрабатывает внутренние платформы и продукты для экосистемы Сбера.",
    employeeCount: 12000,
  ...
  {
    id: "3",
    company: "Норникель Диджитал",
    industry: "Горная добыча",
    segment: "enterprise",
    ...
    companyDescription: "Цифровое подразделение горнодобывающего гиганта. Ответственно за внедрение технологий в производственные процессы на всех предприятиях группы.",
    employeeCount: 3500,
    annualRevenue: "25 млрд ₽",
    location: "Москва / Норильск",
  },
  {
    id: "4",
    company: "РусАгро Групп",
    industry: "Агропром",
    segment: "mid-market",
    ...
    companyDescription: "Один из крупнейших агропромышленных холдингов. Направления: растениеводство, животноводство, масложировой и молочный бизнес.",
    employeeCount: 14000,
    annualRevenue: "210 млрд ₽",
    location: "Тамбов / Москва",
  },
  {
    id: "5",
    company: "Мегафон Корпоративный",
    ...
    companyDescription: "Корпоративное подразделение одного из крупнейших телеком-операторов. Предоставляет B2B-решения для крупного бизнеса и госсектора.",
    employeeCount: 28000,
